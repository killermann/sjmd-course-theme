...
<body <?php body_class(); ?> <?php generate_do_microdata( 'body' ); ?>>
	...
	if ( is_user_logged_in() ) {
	  ...
	  <div class="alert highlight not-logged-in">
		  <p>
		  		<a href="<?php echo esc_url( home_url( '/' ) ); ?>login" class="flex center-everything" title="Sign In" data-no-instant>
					Member Login
		  ...
		  <p>
			  Learn more and enroll in the SJMD Online Course + Community at <a href="https://www.sjmd.space" title="Social Justice, Minus Dogma Course + Community with Sam Killermann">www.sjmd.space →</a>
		  </p>
	  </div>
	<?php };
	?>
